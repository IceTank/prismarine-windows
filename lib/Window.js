  ...
  return class Window extends EventEmitter {
    ...
    shiftClick (click) {
      ...
      if (this.type === 'minecraft:inventory') {
        const equitableSlot = isItemEquipAble(item)
        if (equitableSlot.length !== 0) {
          for (const equipSlot of equitableSlot) {
            if (!this.slots[equipSlot]) {
...
function isItemEquipAble (item) {
  ...
  switch (item.name) {
    case 'elytra': return [slotIds.torso]
    case 'pumpkin': return [slotIds.head] // Only works on pre carved pumpkin
    case 'carved_pumpkin': return [slotIds.head]
    case 'skull': return [slotIds.head]
    case 'shield': return [slotIds['off-hand']]

    case 'turtle_helmet': return [slotIds.head]

    case 'chainmail_helmet': return [slotIds.head]
    case 'chainmail_chestplate': return [slotIds.torso]
    case 'chainmail_leggings': return [slotIds.legs]
    case 'chainmail_boots': return [slotIds.feet]

    case 'leather_helmet': return [slotIds.head]
    case 'leather_chestplate': return [slotIds.torso]
    case 'leather_leggings': return [slotIds.legs]
    case 'leather_boots': return [slotIds.feet]

    case 'iron_helmet': return [slotIds.head]
    case 'iron_chestplate': return [slotIds.torso]
    case 'iron_leggings': return [slotIds.legs]
    case 'iron_boots': return [slotIds.feet]

    case 'gold_helmet': return [slotIds.head]
    case 'gold_chestplate': return [slotIds.torso]
    case 'gold_leggings': return [slotIds.legs]
    case 'gold_boots': return [slotIds.feet]

    case 'diamond_helmet': return [slotIds.head]
    case 'diamond_chestplate': return [slotIds.torso]
    case 'diamond_leggings': return [slotIds.legs]
    case 'diamond_boots': return [slotIds.feet]

    case 'netherite_helmet': return [slotIds.head]
    case 'netherite_chestplate': return [slotIds.torso]
    case 'netherite_leggings': return [slotIds.legs]
    case 'netherite_boots': return [slotIds.feet]
    default: return []
  }
}
